...
public class ExtentListeners implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		String screenshot = ExtentManager.srcfileName;
		//ReportNG
				System.setProperty("org.uncommons.reportng.escape-output","false");
				Reporter.log("<a href="+screenshot+" target=\"_blank\">Screenshot link</a>");
				Reporter.log("<br>");
				Reporter.log("<a href="+screenshot+" target=\"_blank\"><img src="+screenshot+" height=200 width=200></a>");
	...
	public void onTestSkipped(ITestResult result) {
		...
		test.log(Status.SKIP, "Test Skipped as runmode is No");
		test.skip(m);
	}
